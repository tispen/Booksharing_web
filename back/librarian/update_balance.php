...
<html>
	...
	<body>
		<form class="cd-form" method="POST" action="#">
			<center><legend>Обновить баланс пользователю</legend></center>
				...
				<div class="icon">
					<input class="m-user" type='text' name='m_user' id="m_user" placeholder="Ник" required />
				</div>
				
				<div class="icon">
					<input class="m-balance" type="number" name="m_balance" placeholder="Добавить" required />
				</div>
				
				<input type="submit" name="m_add" value="Обновить баланс" />
		</form>
	</body>
